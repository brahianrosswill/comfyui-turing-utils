...
class SAM2Base(torch.nn.Module):
    ...
    @property
    def device(self):
        # Turing Utils: under ComfyUI DynamicVRAM, parameter storage can remain
        # on CPU while this module executes on the patcher's load device.
            ...
            if self.use_obj_ptrs_in_encoder:
                ...
                if len(pos_and_ptrs) > 0:
                    ...
                    if self.add_tpos_enc_to_obj_ptrs:
                        ...
                        # Match the active object-pointer dtype before entering the
                        # learned projection (fp16/bf16 checkpoints otherwise receive
                        # an fp32 positional encoding).
