...
import turing_attention  # noqa: E402
...
class TuringAttentionContractTest(unittest.TestCase):
    ...
    def test_mask_uses_original_attention(self):
        ...
        with mock.patch("turing_attention.is_supported_turing_device", return_value=True):
            output = turing_attention.attention(
    ...
    def test_fp16_hnd_input_and_output_are_preserved(self):
        ...
        with (
            mock.patch("turing_attention.is_supported_turing_device", return_value=True),
            mock.patch("turing_attention._sageattn", return_value=q) as sage,
        ):
            output = turing_attention.attention(
